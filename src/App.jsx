...
export default function App() {
  ...
  return <main className='page'><AuditCommandLayout
    ...
    center={<><ProgressStepper currentStep={stepIndex[phase]} />
      ...
      {phase === 'fundamentals' && <><FundamentalsCard lesson={mission.fundamentalsLesson} mission={mission} variant={variant} /><button className='primary' onClick={() => { setMissionStatus('Fundamentals Reviewed', 94); setPhase('framework'); }}>Continue</button></>}
